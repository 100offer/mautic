...
?>
<table style="border: 1px solid red !important;font-weight: 300;padding: 50px 0;background-color: #f8f8f8; font-family: 'PingFang SC', 'Hiragino Sans GB', arial, 'microsoft yahei', sans-serif; font-size: 14px; min-width: 850px !important;width: 100% !important;margin:0 auto;">
  <tbody>
    <tr>
      <td>
        <table style="border: 1px solid red !important;background-color: #FFFFFF; margin: 0 auto; margin-top: 75px; margin-bottom: 40px; width: 700px !important; min-width: 700px !important;height: 100%; box-shadow: 0 4px 14px 5px rgba(166, 166, 177, 0.07);">
          <tbody style="border: 1px solid red !important;">
            ...
            <tr  style="border: 1px solid red !important;">
              <td style="border: 1px solid red !important;">
                <div style="border: 1px solid red !important;margin: 30px auto;">
                  <div style="border: 1px solid red !important;margin: 0 auto; height: 40px; line-height: 40px; vertical-align: middle; font-size: 20px; text-align: center; color: #17B1F7;">
                       <?php $view['slots']->output('slogan1'); ?>
                  </div>
                  <div style="border: 1px solid red !important;margin: 0 auto; height: 50px; line-height: 50px; vertical-align: middle; font-size: 30px; text-align: center; color: #666666;">
            ...
            <tr style="border: 1px solid red !important;">
              <td style="border: 1px solid red !important;">
                <div style="border: 1px solid red !important;margin-top: 40px;">
            ...
            <tr style="border: 1px solid red !important;">
              <td style="border: 1px solid red !important;">
                <div style="border: 1px solid red !important;margin: 84px 90px 43px;">
                  <div style="border: 1px solid red !important;font-size: 24px; color: #333333; margin-bottom: 14px; height: 28px;">
                      <?php $view['slots']->output('username'); ?>
                  </div>
                  <div style="border: 1px solid red !important;color: #666666; height: 18px; margin-bottom: 11px;">
        ...
        <div style="border: 1px solid red !important;margin: 0 auto 33px; min-width: 700px; text-align: center;">
            <div style="border: 1px solid red !important;font-size: 24px; color: #333333; line-height: 40px; margin-bottom: 13px;">
                <?php $view['slots']->output('footer-slogan'); ?>
            </div>
            <div style="border: 1px solid red !important;line-height: 17px;color: #A6A6A6;">此邮件由100offer发送 </div>
            <div style="border: 1px solid red !important;line-height: 17px;color: #A6A6A6;"><a style="color: #A6A6A6;text-decoration: underline;" href="{unsubscribe_url}">取消推送邮件订阅？</a></div>
        </div>
      </td>
    </tr>
  </tbody>
